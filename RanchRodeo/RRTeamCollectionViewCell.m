...
@interface RRTeamCollectionViewCell()
...
@implementation RRTeamCollectionViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        NSArray *arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"RRTeamCollectionViewCell" owner:self options:nil];
